...
I observed this pattern multiple times over my career:
1. A tool is introduced at some point in the [organisation](https://scrum.wiki/organization), often ignoring the requirements of the users.
1. The processes are adapted to the limitations of the tool.
1. The tool becomes a synonym for the process. The quirks of the tool now legitimise changes to the process.
1. Unused features of the tool are integrated in the processes because they are the default. 

If you care about efficiency, you need to put serious thought in what your requirements are, then which method best fits your requirements, then which tools best fit your method.

An instance of this issue was my inspiration for writing about the [required metrics in Scrum]({% post_url 2025/2025-02-22-scrum-metrics %}).
Organisation keep claiming to choose Scrum, when they are actually choosing [the default Scrum template in Jira](https://www.atlassian.com/software/jira/templates/scrum).
...
Once you choose the method, all tools should work around it.
This is [one of the instructions I defined for luca-decimal](https://github.com/lucafrance/luca-decimal/tree/d36611729a94870fe408ca77347c8b83ec0712c9#consistency-among-different-apps), my personal information management system.
