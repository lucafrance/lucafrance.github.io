...
For anybody interested in n8n, there is a relatively easy way to try it for free as much as you want.
The [community edition of n8n](https://docs.n8n.io/hosting/community-edition-features/) can be self-hosted for free.
...
Type `wsl --install`, then click enter.
...
Download [Docker Desktop](https://www.docker.com/products/docker-desktop/) and open the installer[^docker-wsl].

![Docker Desktop website](/assets/2026/n8n-windows/docker-desktop-website.png)

[^docker-wsl]: You can install Docker over the WSL directly, but Docker Desktop simplifies the installation by executing automatically some of the configurations steps.

Click OK, you don't need Windows containers.
...
Click on *Images > Search mages to run*.
...
If prompted by *Windows Security*, you can cancel.
You don't need to allow access to use n8n locally.
...
You will be prompted to set up an owner account the first time you open it.

**Note:** If you already have a n8n account, it is unrelated from this one.
